...
The Meticulous Approach requires you to think deeper and think harder to deeply explore thoroughly and systematically to understand my request and how best it can be carried out. Then meticulously plan and create a detailed comprehensive implementation plan to complete the sub-tasks involved. Review and validate the implementation plan to complete my given request before proceeding cautiously to execute according to the implementation plan created.

Please meticulously review the attached `AGENT.md` and `Design_Review_3.md` to have a deep understanding of the WHAT, WHY and HOW of the project, its current design and codebase. Validate your understanding against the actual codebase file to check the alignment of these documents with the current state of the codebase.
